...
import { India } from "../../Data/Holidays/India"
...
const IndiaHoliday = () => {
    ...
    return (
        <HolidayWrapper>
            <div style={{ border: "1px solid rgb(128 128 128 / 10%)", marginTop: "5%", marginLeft: "5%", borderRadius: "10px", boxShadow: "10px", background: "rgb(128 128 128 / 10%)" }}>
                <div style={{ width: "50%", marginLeft: "31%", marginTop: "6%", fontSize: "25px" }}>Holidays in the India</div>
                <div style={{
